        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <GlassCard className="p-8 group text-center">
              <h3 className="text-xl font-bold text-white mb-3 tracking-tight">Mid-Market & Enterprise</h3>
              <p className="text-white/50 text-sm leading-relaxed">Growing organizations needing structured marketing systems.</p>
            </GlassCard>
            <GlassCard className="p-8 group text-center">
              <h3 className="text-xl font-bold text-white mb-3 tracking-tight">Leadership Teams</h3>
              <p className="text-white/50 text-sm leading-relaxed">Founders and executives requiring visibility into marketing ROI.</p>
            </GlassCard>
            <GlassCard className="p-8 group text-center">
              <h3 className="text-xl font-bold text-white mb-3 tracking-tight">Marketing Teams</h3>
              <p className="text-white/50 text-sm leading-relaxed">Execution teams managing multiple complex initiatives simultaneously.</p>
            </GlassCard>
          </div>
        </div>
      </section>
