    ...
    <div className={cn("relative w-full overflow-hidden py-12 perspective-1000", className)}>
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  isActive ? "border-accent border-[1.5px] bg-card" : "border-white/5 bg-card/60"
                )}
                style={{
              ...
              >
                ...
                <div className="absolute inset-0 m-4 rounded-xl overflow-hidden bg-black/40 border border-white/5 flex flex-col justify-end p-6">
                    {item.image && (
      ...
      <div className="flex items-center justify-center gap-4 mt-8">
        <button
          ...
          className="p-3 rounded-full bg-card border border-white/10 text-white hover:bg-accent hover:text-black hover:border-accent disabled:opacity-30 disabled:pointer-events-none transition-all"
        >
          <ChevronLeft size={20} />
        </button>
        <span className="text-white/40 text-sm font-medium tracking-widest">
